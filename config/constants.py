...
class SwerveConstants:
    ...
    FL_ENCODER_OFFSET = 15.732421875 # 195.117188
    FR_ENCODER_OFFSET = 184.74609375 # 2.988281
    BL_ENCODER_OFFSET = 48.86718749999999 # 228.515625
    BR_ENCODER_OFFSET = 36.12304687499999
...
class ShooterConstants:
    ...
    INVERT_LEFT_FLYWHEEL = False
    INVERT_RIGHT_FLYWHEEL = True
